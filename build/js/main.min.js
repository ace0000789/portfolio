...
exports.initWorkSwiper = initWorkSwiper;
var _swiper = _interopRequireDefault(require("./vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function initWorkSwiper() {
  var myImageSlider = new _swiper.default('[data-validate="swiper-work"]', {
    navigation: {
...
},{"./vendor/swiper":6}],2:[function(require,module,exports){
"use strict";

var _iosVhFix = require("./utils/ios-vh-fix");
var _initWorkSwiper = require("./init-work-swiper");
var _openImage = require("./open-image");
window.addEventListener('DOMContentLoaded', function () {
  (0, _iosVhFix.iosVhFix)();
  (0, _initWorkSwiper.initWorkSwiper)();
  (0, _openImage.addImageOverlay)();
});

},{"./init-work-swiper":1,"./open-image":3,"./utils/ios-vh-fix":5}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addImageOverlay = addImageOverlay;
function addImageOverlay() {
  ...
  imageContainer.addEventListener('touchend', function () {
    ...
    var swipeThreshold = 50; // Пороговое значение для срабатывания перелистывания
